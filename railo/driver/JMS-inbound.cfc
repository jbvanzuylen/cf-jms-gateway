<cfcomponent extends="Gateway">
  <cfset config = createObject("java", "org.primeoservices.cfgateway.jms.railo.RailoJMSConfiguration") />
  ...
  <cffunction name="getClass" access="public" returntype="string" output="false">
    <cfreturn "org.primeoservices.cfgateway.jms.railo.RailoJMSListenerGateway" />
  </cffunction>
