<cfcomponent displayname="Install" output="false">
  ...
  <cffunction name="install" access="public" returntype="string" output="false">
    ...
    <!--- Update listeners --->
    <cfif NOT directoryExists("#serverPath#/components/railo/extension/gateway/jms")>
      <cfdirectory action="create" directory="#serverPath#/components/railo/extension/gateway/jms" />
    </cfif>
    ...
    <cfloop query="dirContent">
      <cffile action="copy"
              source="#dirPath#/#dirContent.name#"
              destination="#serverPath#/components/railo/extension/gateway/jms/#dirContent.name#"
      />
    </cfloop>
  ...
  <cffunction name="uninstall" access="public" returntype="string" output="false">
    ...
    <cfloop array="#variables.listeners#" index="listener">
      <cfset removeFile("#serverPath#/components/railo/extension/gateway/jms/#listener#", errors) />
    </cfloop>
    <cfdirectory action="delete" directory="#serverPath#/components/railo/extension/gateway/jms" />
